...
namespace PowerBiPipelineSlaTemplate.Core.Pbip
{
    public sealed class PbirReportWriter
    {
        ...
        private static string BuildReportExtensionsJson() => JsonSerializer.Serialize(new { $schema = "https://developer.microsoft.com/json-schemas/fabric/item/report/definition/reportExtension/1.0.0/schema.json", name = "extension", entities = Array.Empty<object>() }, JsonOptions);
